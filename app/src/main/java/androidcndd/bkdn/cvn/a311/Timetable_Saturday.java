...
public class Timetable_Saturday extends AppCompatActivity {
    ...
    ImageButton btnAddSaturday_timetable;
    ListView lvSaturday_timetable;
    ArrayList<CongViec> arrayListSaturday_timetable;
    CongViecAdapter adapterSaturday_timetable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timetable__saturday);
        Create();
        Event();
    }
    ...
    private void Event() {
        ...
        btnAddSaturday_timetable.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnAdd_Dialog_ThemCV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                arrayListSaturday_timetable.add(new CongViec(id,cv,tg,dd));
                adapterSaturday_timetable.notifyDataSetChanged();
                lvSaturday_timetable.setAdapter(adapterSaturday_timetable);

                db.querydata("INSERT INTO ListSaturday VALUES('"+vitri+"','"+cv+"','"+tg+"','"+dd+"')");
        ...
        lvSaturday_timetable.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
        ...
        imgbtndelete_Dialog_optionlv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                arrayListSaturday_timetable.remove(id);
                adapterSaturday_timetable.notifyDataSetChanged();
                lvSaturday_timetable.setAdapter(adapterSaturday_timetable);

                db.querydata("DELETE FROM ListSaturday WHERE id = '"+id+"'");
            ...
            public void onClick(View v) {
                ...
                btnCapNhat_Dialog_CNCV.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        arrayListSaturday_timetable.set(id,new CongViec(id,cv,tg,dd));
                        adapterSaturday_timetable.notifyDataSetChanged();
                        lvSaturday_timetable.setAdapter(adapterSaturday_timetable);

                        db.querydata("UPDATE ListSaturday SET congviec='"+cv+"',thoigian = '"+tg+"',diadiem = '"+dd+"'WHERE id = '"+id+"'");
        ...
        btnOK_dialogthemnhacnho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Timetable_Saturday.this,AlarmReceiver.class);
                pendingIntent = PendingIntent.getBroadcast(Timetable_Saturday.this,0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void Create() {
        //dialog them cong viec
        dialog_ThemCV = new Dialog(Timetable_Saturday.this);
        ...
        //dialog option listview
        dialog_optionlv = new Dialog(Timetable_Saturday.this);
        ...
        //dialog capnhat cong viec
        dialog_capnhatcongviec = new Dialog(Timetable_Saturday.this);
        ...
        //giao dien
        arrayListSaturday_timetable = new ArrayList<>();
        adapterSaturday_timetable = new CongViecAdapter(this,R.layout.dong_listview,arrayListSaturday_timetable);
        lvSaturday_timetable = (ListView) findViewById(R.id.lvSaturday_timetable);
        btnAddSaturday_timetable = (ImageButton) findViewById(R.id.btnAddSaturday_timetable);

        //dialog them nhac nho
        dialog_themnhacnho = new Dialog(Timetable_Saturday.this);
        ...
        db = new MyDBHelper(Timetable_Saturday.this,"quanlycongviec",null,1);
        db.querydata("CREATE TABLE IF NOT EXISTS ListSaturday(id INTEGER PRIMARY KEY,congviec VARCHAR,thoigian VARCHAR,diadiem VARCHAR)");

        Cursor cursor = db.getdata("SELECT * FROM ListSaturday");
        arrayListSaturday_timetable.clear();
        ...
        while(cursor.moveToNext())
        {
            ...
            {
                arrayListSaturday_timetable.add(new CongViec(idnew, cv, tg, dd));
                adapterSaturday_timetable.notifyDataSetChanged();
                lvSaturday_timetable.setAdapter(adapterSaturday_timetable);
                idnew++;
            }
        }
        db.querydata("DELETE FROM ListSaturday");
        cursor.moveToFirst();
        while(vitri!=idnew)
        {
            cv=arrayListSaturday_timetable.get(vitri).getCongviec();
            tg=arrayListSaturday_timetable.get(vitri).getThoigian();
            dd=arrayListSaturday_timetable.get(vitri).getDiadiem();
            id=arrayListSaturday_timetable.get(vitri).getId();
            db.querydata("INSERT INTO ListSaturday VALUES('"+id+"','"+cv+"','"+tg+"','"+dd+"')");
            vitri=id;
            vitri++;
