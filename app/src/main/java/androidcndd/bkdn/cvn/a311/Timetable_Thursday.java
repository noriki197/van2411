    ...
    private void Event() {
        ...
        btnOK_dialogthemnhacnho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Timetable_Thursday.this,AlarmReceiver.class);
                pendingIntent = PendingIntent.getBroadcast(Timetable_Thursday.this,0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
